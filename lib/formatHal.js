...
function formatHal(collectionName, entities, pagingInformation, baseUrl, queryParams) {
  ...
  }, getLink('self', baseUrl, queryParams.page || 1, queryParams));

  const links = generateLinks(baseUrl, pagingInformation.number, pagingInformation.totalPages, queryParams);
